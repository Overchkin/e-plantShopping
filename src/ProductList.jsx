...
import { addItem } from './CartSlice'; // Assurez-vous que l'action addItem est correctement importée

function ProductList({ onHomeClick }) {
    const [showCart, setShowCart] = useState(false);
    const [showPlants, setShowPlants] = useState(false);

    const cart = useSelector(state => state.cart.items); // Récupère les articles du panier depuis Redux
